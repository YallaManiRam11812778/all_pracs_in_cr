def file_parsing(pdf:str):
    try:
        ...
        return {"success":True,"invoice_details":invoice_details,"guest_address":guest_address,"entire":mapping_index_numbers_where_guest_total_occured.to_dict("records")}
    except Exception as e:
        return {"success":False,"message":str(e)}

parsed_file = file_parsing(pdf)